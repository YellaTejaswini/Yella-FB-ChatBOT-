#updated line 184 tf.contrib.rnn. from tf.nn.rnncell and python2to3 and last step changes from models/ckpt to ./ckpt
...
for i in range(numIterations):
	...
	if (i % 10000 == 0 and i != 0):
		savePath = saver.save(sess, "./pretrained_seq2seq.ckpt", global_step=i)
